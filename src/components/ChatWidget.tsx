...
const ChatWidget = () => {
  ...
  const faqResponses: { [key: string]: string } = {
    ...
    'rendez-vous': "Vous pouvez prendre rendez-vous via WhatsApp (0704906086) ou par téléphone (+225 07 07 73 21 60). Nous répondons rapidement !",
    ...
    'contact': "Contactez-nous via WhatsApp (0704906086) ou téléphone (+225 07 07 73 21 60). Nous répondons rapidement !",
    'whatsapp': "Notre numéro WhatsApp est 0704906086. Cliquez sur le bouton vert flottant pour nous contacter directement !"
  };
  ...
  const getBotResponse = (userMessage: string): string => {
    ...
    // Message par défaut
    return "Je ne suis pas sûr de comprendre votre question. Voici ce que je peux vous aider : tarifs, horaires, rendez-vous, nos services, ou notre localisation. Sinon, contactez-nous directement via WhatsApp (0704906086) !";
  };
